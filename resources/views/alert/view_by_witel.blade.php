        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <form id="filter-form" action="{{ route('alert_view_by_witel') }}" method="GET"
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <table id="table-view-by-witel" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Alert</th>
                                        <th>Attribute</th>
                                        @if (!$witel)
                                            @foreach ($distinctWitel as $item)
                                                <th class="witel"
                                                    data-witel="{{ json_encode($distinctWitel->values()->all()) }}">
                                                    {{ $item }}</th>
                                            @endforeach
                                        @else
                                            <th class="witel" data-witel="{{ json_encode([$witel]) }}">
                                                {{ $witel }}
                                            </th>
                                        @endif
                                    </tr>
