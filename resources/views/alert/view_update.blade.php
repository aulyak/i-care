                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td>20</td>
                        <!-- <td>OPEN</td> -->
                        <td><button type="button" class="form-control btn"><i class="nav-icon fas fa-edit" data-toggle="modal" data-target="#modal-lg"></i></button></td>
                      </tr>
                      <tr>
                        <td>121101201842</td>
                        <td>JAKTIM</td>
                ...
                <form>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="atribut" placeholder="Enter Atribut">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="bulan_alert" placeholder="Enter Bulan Alert">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="deskripsi" placeholder="Enter Deskripsi">
                    </div>
                    <div class="form-group">
