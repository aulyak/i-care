...
return [
  ...
  'menu' => [
    ...
    [
      ...
      'submenu' => [
        [
          'text' => 'Alert View by Age',
          'url'  => 'alert_view_by_age',
          'icon'    => 'fa fa-arrow-circle-right nav-icon',
        ],
        [
          'text' => 'Alert View by Witel',
          'url'  => 'alert_view_by_witel',
          'icon'    => 'fa fa-arrow-circle-right nav-icon',
        ],
        [
          'text' => 'Alert Update',
          'url'  => 'alert_view_update',
          'icon'    => 'fa fa-arrow-circle-right nav-icon',
        ],
      ]
    ],
    [
      'text'    => 'Quality of Sales',
